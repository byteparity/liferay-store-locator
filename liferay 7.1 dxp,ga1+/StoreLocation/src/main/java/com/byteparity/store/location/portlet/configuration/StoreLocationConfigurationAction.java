...
@Component(
	    configurationPid = "com.byteparity.store.location.portlet.configuration.StoreLocationConfiguration",
...
public class StoreLocationConfigurationAction extends DefaultConfigurationAction {
    ...
    public void processAction(PortletConfig portletConfig, ActionRequest actionRequest,ActionResponse actionResponse)throws Exception {
        ...
        setPreference(actionRequest, "enableSearchFilter", ParamUtil.getString(actionRequest, "enableSearchFilter"));
